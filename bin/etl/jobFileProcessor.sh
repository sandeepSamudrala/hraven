...
hadoop --config $1 jar $hravenEtlJar com.twitter.hraven.etl.JobFileProcessor -libjars=$LIBJARS -Dmapred.fairscheduler.pool=$2 "${@:11}" -d -p $3 -c $4 -t $5 -b $6 -m $7 -s $8 -zf $9 -tt ${10}